...
const DashboardAnalytics = () => {
  ...
  const { isPaid, can } = useSubscription();
  ...
  // TODO Implement a designed page for this response.
  if (!can("analytics")) {
    return <Pricing />;
  }
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      >
        <p className="font-display text-2xl text-gray-900 font-bold">
          Analytics
        </p>
        <p className="text-gray-600 text-xs">
          Track performance and insights for your forms.
        </p>
      </div>
      {loading ? (
        ...
        <div
          className="text-center py-24 animate-slide-up"
        ...
        >
          ...
          <p className="text-gray-600 mb-8">
            Create a form to start tracking analytics and responses.
          </p>
          <button
          ...
          >
            <span className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-900 text-2xl leading-none transition-colors">
              +
            </span>
            Create form
          </button>
            ...
            {forms.map((form, index) => (
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <h3 className="font-display text-sm font-medium text-gray-900 truncate">
                    {form.title}
                  </h3>
                </div>
