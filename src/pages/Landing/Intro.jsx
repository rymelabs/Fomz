...
const Intro = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-white">
      ...
      <div
        className="pointer-events-none absolute bottom-0 -left-24 h-[28rem] w-[28rem] animate-blob rounded-full bg-gradient-to-tl from-[#B6F3CF] via-[#B6F3CF]/60 to-transparent opacity-80 blur-3xl"
      ...
      <div className="relative flex min-h-screen flex-col items-center justify-center px-6 py-12 text-center">
        <div className="space-y-4">
          <div className="space-y-2">
            <p className="font-display text-6xl text-gray-900 tracking-tight">
              fomz
            </p>
            <p className="font-poppins text-xs uppercase tracking-[0.5em] text-gray-500 mb-6">
              by RymeLabs
            </p>
          </div>
          <div className="h-12 flex items-center justify-center text-gray-800">
            <p
              className={`font-display text-[12px] transition-all duration-500 ${
                isVisible
